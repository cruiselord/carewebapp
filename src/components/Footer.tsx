import { Facebook, Instagram, Twitter, Linkedin, User, Home, MapPin, Briefcase, Calendar, PhoneCall } from "lucide-react";
...
const Footer = () => {
  const navigationLinks = [
    ...
    { name: "Call", icon: <PhoneCall className="w-4 h-4" />, path: "/contact" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600">
              Providing compassionate home care services to help seniors live independently in their own homes.
            </p>
          </div>
